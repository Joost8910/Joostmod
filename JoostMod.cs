...
namespace JoostMod
{
    public class JoostMod : Mod
    {
        ...
        public void InitializeHunts()
        {
            ...
            new HuntInfo(ModContent.NPCType<ImpLord>(),  Main.remixWorld ? 0.5f : 6.8f, "Go to hell! Literally! Dig down until ya find yerself surrounded by lava and demons! Among those demons are fire imps: little teleportin' buggers that shoot fire! They have a leader with wings that's especially dangerous. Watch out for his giant fire blast attack! Ya can use a sword to reflect it back at him but if you fail to it hurts a lot!", "Good job taking down the Imp Lord! Here, ya can use the tail as a whip or somethin'", ModContent.ItemType<Items.Quest.ImpLord>(), 
            () => Main.remixWorld ? true : JoostWorld.downedCactusWorm, () => JoostWorld.downedImpLord, () => true, ImpReward),
