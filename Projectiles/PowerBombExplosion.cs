...
namespace JoostMod.Projectiles
{
	public class PowerBombExplosion : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch sb, Color lightColor)
		{
            ...
            sb.Draw(tex, projectile.Center - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), new Rectangle?(new Rectangle(0, 0, tex.Width, tex.Height)), color, projectile.rotation, new Vector2(tex.Width/2, tex.Height/2), projectile.scale * 2, SpriteEffects.None, 0f);
            sb.Draw(tex, projectile.Center - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), new Rectangle?(new Rectangle(0, 0, tex.Width, tex.Height)), color, projectile.rotation, new Vector2(tex.Width / 2, tex.Height / 2), projectile.scale * 8, SpriteEffects.None, 0f);
            return false;
		}
		public override void Kill(int timeLeft)
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("PowerBombExplosion2"), (int)(projectile.damage * 0.25f), projectile.knockBack, projectile.owner);
		}
	}
}