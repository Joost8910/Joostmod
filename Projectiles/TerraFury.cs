...
namespace JoostMod.Projectiles
{
    public class TerraFury : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            else if (Projectile.ai[0] == 1f)
            {
                ...
                if (num209 > (float)num216 || !Projectile.tileCollide)
                {
                    ...
                    {
                        Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("TerraFuryBeam").Type, (int)(Projectile.damage * 1.0f), 0, Projectile.owner);
        ...
        {
            Texture2D texture = (Texture2D)Mod.Assets.Request<Texture2D>("JoostMod/Projectiles/TerraFury_Chain");
            Player player = Main.player[Projectile.owner];
