    ...
    public class ChanneledNail : ModProjectile
    {
           ...
           projectile.ai[0]++;
            if(Main.myPlayer == projectile.owner)
            {
                ...
                if(channeling)
                {
                    ...
                    if (projectile.ai[0] >= 35 && projectile.ai[0] < 110)
                    {
        ...
        public override void Kill(int timeLeft)
        {
            if(projectile.ai[0] > 110)
            {
                ...
                if (Math.Abs(player.velocity.X) > 7 && player.velocity.X * projectile.velocity.X > 0 && Math.Abs(projectile.velocity.Y) < 3)
                {
            ...
            else
            {
                ...
                Projectile.NewProjectile(pos.X, pos.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("ChanneledNail2"), projectile.damage, projectile.knockBack, projectile.owner);
