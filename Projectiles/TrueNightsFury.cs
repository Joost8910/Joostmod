...
namespace JoostMod.Projectiles
{
    public class TrueNightsFury : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            else if (projectile.ai[0] == 1f)
            {
                ...
                if (num209 > (float)num216 || !projectile.tileCollide)
                {
                    ...
                    {
                        Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("TrueNightsFuryBeam"), (int)(projectile.damage * 1.0f), 0, projectile.owner);
        ...
        {
            Texture2D texture = ModContent.GetTexture("JoostMod/Projectiles/TrueNightsFury_Chain");
            Player player = Main.player[projectile.owner];
