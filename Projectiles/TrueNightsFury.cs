        ...
        public override bool PreAI()
        {
            ...
            else if (Projectile.ai[0] == 1f)
            {
                ...
                if (num209 > (float)num216 || !Projectile.tileCollide)
                {
                    ...
                    {
                        Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("TrueNightsFuryBeam").Type, (int)(Projectile.damage * 1.0f), 0, Projectile.owner);
