...
{
    public class NightsFuryBeam : ModProjectile
    {
        ...
        private readonly int dustId = DustID.Shadowflame;
        private readonly int maxTime = 25;
        private readonly float maxScale = 3.5f;
        private readonly Vector3 lightColor = new Vector3(0.5f, 0.8f, 0.25f);
