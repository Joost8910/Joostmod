...
{
    public class NightsFury : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            else if (Projectile.ai[0] == 1f)
            {
                ...
                float num213 = 300f;
                num213 *= 2f; // Distance when it forces back
                num211 *= 1f; // Floatiness?
                num212 *= 1.2f; // Comeback Speed
        ...
        {
            Texture2D texture = (Texture2D)Mod.Assets.Request<Texture2D>("JoostMod/Projectiles/NightsFury_Chain");
            Player player = Main.player[Projectile.owner];
