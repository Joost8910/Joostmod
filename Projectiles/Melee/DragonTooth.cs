        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft <= 120)
            {
                    ...
                    if (Projectile.ai[1] > 150 && Projectile.localAI[1] < 10)
                    {
                        if (player.velocity.Y == 0)
                        {
                            if (Projectile.ai[0] < 100)
                            {
                                ...
                                SoundEngine.PlaySound(new("Terraria/Sounds/Custom/dd2_monk_staff_ground_impact_0"), Projectile.Center); //207
                ...
                if (Projectile.timeLeft == 68 && Projectile.ai[0] < 100)
                {
                    ...
                    {
                        SoundEngine.PlaySound(new("Terraria/Sounds/Custom/dd2_monk_staff_ground_miss_0"), Projectile.Center); //210
                    }
                }
