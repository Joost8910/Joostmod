    ...
    public class TrueDarkLance : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.itemAnimation < player.itemAnimationMax / 2)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Projectile.velocity, Mod.Find<ModProjectile>("TrueDarkLanceBeam").Type, Projectile.damage, Projectile.knockBack / 2, Projectile.owner);
                    Projectile.ai[1]++;
                }
                Projectile.ai[0] -= 2f;
            }
