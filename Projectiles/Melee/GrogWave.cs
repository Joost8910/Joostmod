...
namespace JoostMod.Projectiles.Melee
{
    public class GrogWave : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //{
            Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.position.X, Projectile.position.Y, 0, 15f, Mod.Find<ModProjectile>("GrogWave1").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.spriteDirection, Projectile.scale);
