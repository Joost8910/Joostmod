...
namespace JoostMod.Projectiles.Melee
{
    public class AwokenDreamDashSlash : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            {
                for (int i = 0; i < 12; i++)
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.WitherLightning, player.velocity.X, player.velocity.Y, 100, default, 1.3f + Main.rand.Next(5) / 10).noGravity = true;
            }
            Projectile.ai[0]++;
            ...
            Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.WitherLightning, Projectile.velocity.X, Projectile.velocity.Y, 100, default, 0.8f + Main.rand.Next(5) / 10).noGravity = true;
