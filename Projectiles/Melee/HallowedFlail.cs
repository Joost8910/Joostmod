...
{
    public class HallowedFlail : ModProjectile
    {
        ...
        {
            Texture2D texture = (Texture2D)Mod.Assets.Request<Texture2D>("JoostMod/Projectiles/HallowedFlail_Chain");
            Player player = Main.player[Projectile.owner];
