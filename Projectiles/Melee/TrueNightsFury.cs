...
{
    public class TrueNightsFury : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            else if (Projectile.ai[0] == 1f)
            {
                ...
                float num213 = 300f;
                num213 *= 2.3f; // Distance when it forces back
                num211 *= 1.1f; // Floatiness?
                num212 *= 1.3f; // Comeback Speed
                ...
                if (num209 > num216 || !Projectile.tileCollide)
                {
                    ...
                    {
                        Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("TrueNightsFuryBeam").Type, (int)(Projectile.damage * 1.0f), 0, Projectile.owner);
        ...
        {
            Texture2D texture = (Texture2D)Mod.Assets.Request<Texture2D>("JoostMod/Projectiles/TrueNightsFury_Chain");
            Player player = Main.player[Projectile.owner];
