...
namespace JoostMod.Projectiles.Melee
{
    public class TrueNightsFury : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            else if (Projectile.ai[0] == 1f)
            {
                ...
                if (num209 > num216 || !Projectile.tileCollide)
                {
                    ...
                    {
                        Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X, Projectile.Center.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<TrueNightsFuryBeam>(), (int)(Projectile.damage * 1.0f), 0, Projectile.owner);
        ...
        {
            Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("JoostMod/Projectiles/TrueNightsFury_Chain");
            Player player = Main.player[Projectile.owner];
