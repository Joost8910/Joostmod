	...
	public class TrueGungnir : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            if (player.inventory[player.selectedItem].shoot == projectile.type)
            {
                ...
                speed = (((27f / player.inventory[player.selectedItem].useTime) / player.meleeSpeed)) * projectile.scale;
			...
			if (player.itemAnimation < player.itemAnimationMax / 2)
            {
                ...
                {
                    Projectile.NewProjectile(projectile.Center, projectile.velocity, mod.ProjectileType("TrueGungnirBeam"), projectile.damage, projectile.knockBack / 2, projectile.owner);
                    projectile.ai[1]++;
                }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            vel.Normalize();
            spriteBatch.Draw(tex, projectile.Center - Main.screenPosition - vel * 90 * projectile.scale, new Rectangle?(new Rectangle(0, 0, tex.Width, tex.Height)), color, projectile.rotation, drawOrigin, projectile.scale, effects, 0f);
            return false;
        }
    }
}