...
public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        ...
        public override bool PreAI()
        {
            ...
            Dust.NewDust(projectile.position, projectile.width,projectile.height, 71, projectile.velocity.X/2, projectile.velocity.Y/2, 100, default(Color), (0.8f + (Main.rand.Next(5)/10)));
            Dust.NewDust(projectile.position, projectile.width,projectile.height, 71, projectile.velocity.X/2, projectile.velocity.Y/2, 100, default(Color), (0.8f + (Main.rand.Next(5)/10)));
