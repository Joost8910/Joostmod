...
{
    public class BrokenFishHook : ModProjectile
    {
        ...
        public override bool PreDrawExtras()      //this draws the fishing line correctly
        {
            ...
            if (Projectile.bobber && Main.player[Projectile.owner].inventory[Main.player[Projectile.owner].selectedItem].holdStyle > 0)
            {
                ...
                if (type == ModContent.ItemType<BrokenFishingPole>()) //add your Fishing Pole name here
                {
                ...
                while (flag2)
                {
                    ...
                    else
                    {
                        ...
                        Color color2 = Lighting.GetColor((int)value.X / 16, (int)(value.Y / 16f), Color.Gray);
