            ...
            if (Projectile.bobber && Main.player[Projectile.owner].inventory[Main.player[Projectile.owner].selectedItem].holdStyle > 0)
            {
                ...
                while (flag2)
                {
                    ...
                    else
                    {
                        ...
                        Color color2 = Lighting.GetColor((int)value.X / 16, (int)(value.Y / 16f), new Color(66, 248, 171, 100));    //this is the fishing line color in RGB, 200 is red, 12 is green, 50 blue
