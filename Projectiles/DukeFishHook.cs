...
{
	public class DukeFishHook : ModProjectile
	{
        ...
        public override bool PreDrawExtras()      //this draws the fishing line correctly
        {
            ...
            if (Projectile.bobber && Main.player[Projectile.owner].inventory[Main.player[Projectile.owner].selectedItem].holdStyle > 0)
            {
                ...
                if (type == Mod.Find<ModItem>("DukeFishingGun>().Type) //add your Fishing Pole name here
                {
                ...
                while (flag2)
                {
                    ...
                    else
                    {
                        ...
                        Microsoft.Xna.Framework.Color color2 = Lighting.GetColor((int)value.X / 16, (int)(value.Y / 16f), new Microsoft.Xna.Framework.Color(255, 249, 183, 100));
