...
namespace JoostMod.Projectiles
{
	public class EndlessBoomerangBullet : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("EndlessBoomerangBullet2"), (int)(projectile.damage * 1f), projectile.knockBack, projectile.owner);		
			}
			else
			{
				for (int i = 0; i < 4; i++)
