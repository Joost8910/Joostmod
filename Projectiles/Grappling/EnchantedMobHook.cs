            ...
            */
            if (grappleSwing >= 0)
            {
                ...
                if (up || down)
                {
                    ...
                    //player.velocity = Vector2.SmoothStep(player.velocity, vect, 0.2f);
        ...
        public override bool PreDrawExtras()
        {
            ...
            while (flag2)
            {
                ...
                else
                {
                    ...
                    Texture2D tex = (Texture2D)ModContent.Request<Texture2D>("JoostMod/Projectiles/Grappling/EnchantedMobHook_Chain");
