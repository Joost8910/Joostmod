    ...
    public class ImpLordFlame : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                if (Projectile.ai[0] < 40)
                {
                    Projectile.NewProjectile(pos.X, pos.Y, dir.X * 5, dir.Y * 5, Mod.Find<ModProjectile>("BurningSphere").Type, Projectile.damage, Projectile.knockBack, Projectile.owner);
                    SoundEngine.PlaySound(SoundID.Item1, Projectile.Center);
                }
                else if (Projectile.ai[0] < 60)
                {
                    Projectile.NewProjectile(pos.X, pos.Y, dir.X * 12, dir.Y * 12, Mod.Find<ModProjectile>("FireBolt").Type, (int)(Projectile.damage * 2.5f), Projectile.knockBack * 3, Projectile.owner);
                ...
                else if (Projectile.ai[0] == 100)
                {
                    ...
                    */
                    Projectile.NewProjectile(pos.X, pos.Y, dir.X * 8, dir.Y * 8, Mod.Find<ModProjectile>("FireBlast").Type, Projectile.damage * 3, Projectile.knockBack * 5, Projectile.owner);
