	...
	public class ActualFlamingMace : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[1] == 0)
            {
                ...
                if (Main.tile[tilePos.X, tilePos.Y].liquid > 200 && Main.tile[tilePos.X, tilePos.Y].liquidType() != 2)
                {
                    projectile.localAI[1] = 1;
                    Main.PlaySound(2, (int)projectile.position.X, (int)projectile.position.Y, 13, 0.8f, 0.2f);
                }
            }
        }
