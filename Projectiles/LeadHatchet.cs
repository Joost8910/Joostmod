...
namespace JoostMod.Projectiles
{
	public class LeadHatchet  : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
		{
			...
			Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("LeadHatchet2").Type, (int)(Projectile.damage * 1f), 3, Projectile.owner);
