...
namespace JoostMod.Projectiles
{
	public class PlatinumHatchet  : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
		{
			...
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("PlatinumHatchet2"), (int)(projectile.damage * 1f), 3, projectile.owner);
