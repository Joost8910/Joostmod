        ...
        public override bool PreAI()
        {
            ...
            if (Projectile.ai[1] == 0) //Rapid Slash
            {
                ...
                if (Projectile.ai[0] != 2)
                {
                    ...
                    {
                        Projectile.NewProjectileDirect(origin, Projectile.velocity, Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 2, 0);
                    }
                }
            }
            if (Projectile.ai[1] == 1) //Leaping Slash
            {
                ...
                else
                {
                    ...
                    if (Projectile.localAI[0] == 0)
                    {
                        ...
                        {
                            Projectile.NewProjectileDirect(origin, Projectile.velocity, Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, 2, 1);
                            ...
                            SoundEngine.PlaySound(SoundID.Trackable, origin);
                            SoundEngine.PlaySound(SoundID.Trackable, origin);
                        }
