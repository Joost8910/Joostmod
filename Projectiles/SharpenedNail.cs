    ...
    public class SharpenedNail : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(pos.X, pos.Y, Projectile.velocity.X, Projectile.velocity.Y, Mod.Find<ModProjectile>("SharpenedNail2").Type, Projectile.damage, Projectile.knockBack, Projectile.owner);
