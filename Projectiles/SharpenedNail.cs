    ...
    public class SharpenedNail : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            else
            {
                ...
                Projectile.NewProjectile(pos.X, pos.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("SharpenedNail2"), projectile.damage, projectile.knockBack, projectile.owner);
