...
namespace JoostMod.Projectiles.Magic
{
    public class SapSpell : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            color *= 0.7f;
            Main.EntitySpriteDraw(tex, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Rectangle?(rect), color, Projectile.rotation, drawOrigin, Projectile.scale, SpriteEffects.None, 0);
            return false;
        }
    }
}
