...
namespace JoostMod.Projectiles
{
	public class GilgExcalipoor : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Gore.NewGore(projectile.position, projectile.velocity, mod.GetGoreSlot("Gores/Excalipoor1"), 1f);
            Gore.NewGore(projectile.position, projectile.velocity, mod.GetGoreSlot("Gores/Excalipoor2"), 1f);
        }
