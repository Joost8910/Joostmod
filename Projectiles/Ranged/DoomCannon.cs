...
namespace JoostMod.Projectiles.Ranged
{
    public class DoomCannon : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Projectile.ai[0] == 660)
            {
                SoundEngine.PlaySound(new("Terraria/Sounds/Custom/dd2_phantom_phoenix_shot_0"), Projectile.position); //217
            }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner && !player.dead && !Main.mouseRight && Projectile.ai[0] >= 60)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_Death(), pos, Projectile.velocity * speed, type, (int)(Projectile.damage * mult), Projectile.knockBack * mult, Projectile.owner);
            }
        }
    }
}