    ...
    public class GiantArrow : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                ...
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<Shrapnel>(), (int)(Projectile.damage * 0.66f), Projectile.knockBack * 0.66f, Projectile.owner);
            }
        }
    }
}
