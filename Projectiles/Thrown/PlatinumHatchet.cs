...
namespace JoostMod.Projectiles.Thrown
{
    public class PlatinumHatchet : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, Mod.Find<ModProjectile>("PlatinumHatchet2").Type, (int)(Projectile.damage * 1f), 3, Projectile.owner);
