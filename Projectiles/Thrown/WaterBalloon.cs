    ...
    public class WaterBalloon : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (i = 0; i < shootNum; i++)
            {
                ...
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, baseSpeed * (float)Math.Sin(offsetAngle), baseSpeed * (float)Math.Cos(offsetAngle), 22, Projectile.damage, Projectile.knockBack, Projectile.owner);
            }
