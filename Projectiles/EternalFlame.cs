...
namespace JoostMod.Projectiles
{
	public class EternalFlame : ModProjectile
	{
        ...
        public override void AI()
		{
			...
			{
				int num1 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 127, Projectile.velocity.X/10, Projectile.velocity.Y/10, 100, default(Color), 2f);
