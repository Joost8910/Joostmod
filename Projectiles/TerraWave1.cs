		...
		public override void Kill(int timeLeft)
		{
			...
			if (tileSafely.active())
			{
				...
				if (!tileSafely2.active() || !Main.tileSolid[(int)tileSafely2.type] || Main.tileSolidTop[(int)tileSafely2.type])
				{
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y + offset, 0, 0, mod.ProjectileType("TerraWave2"), projectile.damage, projectile.knockBack, projectile.owner, projectile.ai[0]);					
				}
			}
		}
	}
