	...
	public class TerraSpear : ModProjectile
	{
		...
		public override void AI()
        {
			...
			if (player.itemAnimation < player.itemAnimationMax * 2f / 3f)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.Center, Projectile.velocity, Mod.Find<ModProjectile>("TerraSpearBeam").Type, Projectile.damage, Projectile.knockBack / 2, Projectile.owner);
                    Projectile.ai[1]++;
                }
