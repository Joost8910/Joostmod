...
public override void Kill(int timeLeft)
		{
			...
			if (tileSafely.HasTile)
			{
				...
				if ((!tileSafely2.HasTile || !Main.tileSolid[(int)tileSafely2.TileType] || Main.tileSolidTop[(int)tileSafely2.TileType]))
				{
					...
					Projectile.NewProjectile(Projectile.Center.X, Projectile.Center.Y + 8, 0, 0, Mod.Find<ModProjectile>("EarthWave2").Type, Projectile.damage, Projectile.knockBack, Projectile.owner);					
				}
			}
		}
	}
