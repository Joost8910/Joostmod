        ...
        public override bool PreDrawExtras()
        {
            ...
            while (flag2)
            {
                ...
                else
                {
                    ...
                    Main.spriteBatch.Draw(TextureAssets.Chain16.Value, new Vector2(value.X - Main.screenPosition.X + (float)TextureAssets.Chain16.Value.Width * 0.5f, value.Y - Main.screenPosition.Y + (float)TextureAssets.Chain16.Value.Height * 0.5f), new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(0, 0, TextureAssets.Chain16.Value.Width, (int)num)), color2, rotation2, new Vector2((float)TextureAssets.Chain16.Value.Width * 0.5f, 0f), 1f, SpriteEffects.None, 0f);
                }
            }
            return false;
        }
