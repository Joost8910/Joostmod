    ...
    public class EarthElemental : ModNPC
    {
        ...
        */
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            spriteBatch.Draw(tex, new Vector2(NPC.position.X - Main.screenPosition.X + NPC.width / 2 - tex.Width / 2f + drawOrigin.X + offSet.X, NPC.position.Y - Main.screenPosition.Y + NPC.height - tex.Height + 4f + drawOrigin.Y + offSet.Y), new Rectangle?(rect), drawColor, NPC.rotation, drawOrigin, 1f, effects, 0f);
