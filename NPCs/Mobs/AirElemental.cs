        ...
        */
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life <= 0)
            {
                for (int k = 0; k < 20; k++)
                {
                    Dust.NewDust(NPC.position, NPC.width, NPC.height, 16, 2.5f * hit.HitDirection, Main.rand.Next(-5, 5), 0, default, 0.7f);
                }
            }
        }
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] == 220)
            {
                for (int d = 0; d < 20; d++)
                {
                    Dust dust = Dust.NewDustDirect(NPC.Center - new Vector2(10, 10), 20, 20, 31, NPC.velocity.X * 0.8f, NPC.velocity.Y * 0.8f, 0, default, 1.5f);
            ...
            {
                Dust.NewDustDirect(NPC.Center - new Vector2(10, 10), 20, 20, 31, NPC.velocity.X * 0.8f, NPC.velocity.Y * 0.8f, 0, default, 1f);
            }
            if (NPC.ai[3] > 10)
            {
                ...
                if (NPC.ai[0] >= 240 && Collision.CanHitLine(NPC.Center - new Vector2(20, 20), 40, 40, P.Center, 1, 1) && NPC.ai[2] == 0)
                {
                    ...
                    for (int d = 0; d < 10; d++)
                    {
                        Dust.NewDust(NPC.Center - new Vector2(10, 10), 20, 20, 31, dir.X * Speed, dir.Y * Speed, 0, default, 2f);
                    }
                    NPC.ai[0] = 0;
                    NPC.velocity = dir * -10;
                }
