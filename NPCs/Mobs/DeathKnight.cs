    ...
    public class DeathKnight : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (Main.netMode != NetmodeID.Server && NPC.life <= 0)
            {
                ...
                for (int k = 0; k < 50; k++)
                {
                    Dust.NewDust(NPC.position, NPC.width, NPC.height, 109, 2.5f * hit.HitDirection, Main.rand.Next(-5, 5), 0, default, 0.7f);
                }
            }
        }
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                {
                    Dust.NewDust(NPC.position, NPC.width, NPC.height, 20, Main.rand.Next(-5, 5), Main.rand.Next(-5, 5), 0, default, 0.7f);
                }
            ...
            {
                Dust.NewDust(NPC.position, NPC.width, NPC.height, 109, Main.rand.Next(-5, 5), Main.rand.Next(-5, 5), 0, default, 0.7f);
