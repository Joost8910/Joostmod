    ...
    public class GiantNeedle : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            if (NPC.localAI[0] > 0)
            {
                ...
                Vector2 vector3 = new Vector2(num2 / value.Width, 2f);
                Vector2 vector4 = new Vector2(num2 / value.Width * 0.5f, 2f);
                Color color = Color.White * Utils.GetLerpValue(0, 1, NPC.localAI[0]);
                Main.spriteBatch.Draw(value, vector, default, color, rot, vector2, vector4, 0, 0f);
                Main.spriteBatch.Draw(value, vector, default, color * 0.3f, rot, vector2, vector3, 0, 0f);
            }
        }
    }
}
