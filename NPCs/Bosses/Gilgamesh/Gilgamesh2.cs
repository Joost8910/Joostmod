...
namespace JoostMod.NPCs.Bosses.Gilgamesh
{
    [AutoloadBossHead]
    public class Gilgamesh2 : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D ribbonTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_Ribbons");
            int totalRibbonFrames = 6;
            int ribbonFrame = 0;
            float ribbonRotation = 0;
            Vector2 ribbonOffset = new Vector2(0, 0);

            ribbonFrame = (int)(NPC.ai[0] * 1.2f) % 60 / 10;
            ...
            Texture2D flailTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_FlailArm");
            ...
            Texture2D naginataTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_NaginataArm");
            ...
            Texture2D axeTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_AxeArm");
            ...
            Texture2D shieldTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_ShieldArm");
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D kunaiTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_KunaiArm");
            ...
            Texture2D excalipoorTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_ExcalipoorArms");
            ...
            Texture2D busterSwordTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_BusterSwordArm");
            ...
            Texture2D masamuneTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_MasamuneArm");
            ...
            Texture2D gunBladeTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_GunBladeArm");
            ...
            Texture2D eyesTex = (Texture2D)ModContent.Request<Texture2D>($"{Texture}_Eyes");
            ...
            if (NPC.ai[2] >= 1)
            {
                ...
                Vector2 vector = new Vector2(3 * NPC.direction - (NPC.direction == 1 ? 1 : 0), -11.5f) + Vector2.UnitY * NPC.gfxOffY + NPC.Size / 2f;
                Vector2 vector2 = new Vector2(3 * NPC.direction - (NPC.direction == 1 ? 1 : 0), -11.5f) + NPC.Size / 2f;
                ...
                {
                    Dust expr_3D9 = Main.dust[Dust.NewDust(NPC.Center + eyeGlowOffset, 0, 0, 182, 0f, 0f, 0, default, 1f)];
                    expr_3D9.position = Vector2.Lerp(vector5, vector4, num6 / num5);
        ...
        public override bool CheckDead()
        {
            if (NPC.ai[3] != 100)
            {
                SoundEngine.PlaySound(new SoundStyle("JoostMod/Sounds/Custom/Gilgamesh"), NPC.Center);
                NPC.ai[0] = 120;
                NPC.frame.Y = 0;
