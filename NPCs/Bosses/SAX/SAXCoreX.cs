...
namespace JoostMod.NPCs.Bosses.SAX
{
    ...
    public class SAXCoreX : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            float rotation = 0;
            spriteBatch.Draw(tex, new Vector2(NPC.position.X - Main.screenPosition.X + NPC.width / 2 - tex.Width / 1 / 2f + vect.X - 2f, NPC.position.Y - Main.screenPosition.Y + NPC.height / 2 - tex.Height / 16 + 2f + vect.Y), new Rectangle?(rect), color, rotation, vect, NPC.scale, effects, 0f);
            ...
            spriteBatch.Draw(texture, new Vector2(NPC.position.X - Main.screenPosition.X + NPC.width / 2 - texture.Width / xFrameCount / 2f + vector.X, NPC.position.Y - Main.screenPosition.Y + NPC.height - texture.Height / Main.npcFrameCount[NPC.type] + 12f + vector.Y), new Rectangle?(rectangle), color, NPC.rotation, vector, NPC.scale, effects, 0f);
            return false;
        }
