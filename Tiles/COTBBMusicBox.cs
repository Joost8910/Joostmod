...
namespace JoostMod.Tiles
{
	class COTBBMusicBox : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, Mod.Find<ModItem>("COTBBMusicBox").Type);
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("COTBBMusicBox").Type;
		}
	}
}
