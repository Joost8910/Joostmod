...
{
	public class SpongeStationLava : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Lava Absorbtion Pump");
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.SpongeStationLava>();
		}
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 48, ModContent.ItemType<Items.Placeable.SpongeStationLava>());
		}
		...
		public override void HitWire(int i, int j)
		{
            ...
            for (int l = x; l < x + 3; l++)
			{
                for (int m = y; m < y + 3; m++)
                {
                    ...
                    if (tile.LiquidAmount > 0 && tile.LiquidType == 1)
                    {
