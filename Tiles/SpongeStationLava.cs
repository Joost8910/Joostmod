...
namespace JoostMod.Tiles
{
	public class SpongeStationLava : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = Mod.Find<ModItem>("SpongeStationLava").Type;
		}
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 48, Mod.Find<ModItem>("SpongeStationLava").Type);
		}
