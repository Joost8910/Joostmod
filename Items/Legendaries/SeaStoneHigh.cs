...
namespace JoostMod.Items.Legendaries
{
    public class SeaStoneHigh : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = Mod.Find<ModTile>("SeaStoneHigh").Type;
        }
        public override void ModifyTooltips(List<TooltipLine> list)
        {
            foreach (TooltipLine line2 in list)
            {
                ...
                {
                    line2.OverrideColor = new Color(0, (int)(Main.DiscoB * 0.8f), 255);
                }
            }
        }
        ...
        {
            Texture2D tex = (Texture2D)ModContent.Request<Texture2D>("JoostMod/Items/Legendaries/SeaStoneHigh");
            drawColor = new Color(0, (int)(Main.DiscoB * 0.8f), 255);
        ...
        public override void PostDrawInWorld(SpriteBatch sb, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            lightColor = new Color(0, (int)(Main.DiscoB * 0.8f), 255);
