    ...
    public class SeaStoneDeep : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> list)
        {
            foreach (TooltipLine line2 in list)
            {
                ...
                {
                    line2.OverrideColor = new Color(0, 0, 51 + (int)((255 - Main.DiscoB) * 0.8f));
                }
            }
        }
        ...
        {
            Texture2D tex = (Texture2D)ModContent.Request<Texture2D>("JoostMod/Items/Legendaries/SeaStoneDeep");
            drawColor = new Color(0, 0, 51 + (int)((255 - Main.DiscoB) * 0.8f));
        ...
        public override void PostDrawInWorld(SpriteBatch sb, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            lightColor = new Color(0, 0, 51 + (int)((255 - Main.DiscoB) * 0.8f));
