...
namespace JoostMod.Items.Legendaries
{
    public class EvilStone : ModItem
    {
        ...
        {
            Texture2D tex = (Texture2D)Mod.Assets.Request<Texture2D>("JoostMod/Items/Placeable/EvilStone");
            drawColor = new Color(127, 0, Main.DiscoG);
            sb.Draw(tex, position, frame, drawColor, 0f, origin, scale, SpriteEffects.None, 0f);
            Texture2D tex2 = (Texture2D)Mod.Assets.Request<Texture2D>("JoostMod/Items/Placeable/EvilStonePupil");
