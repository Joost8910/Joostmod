...
namespace JoostMod.Buffs
{
	public class InfectedYellow : ModBuff
	{
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            {
                Dust.NewDust(player.position, player.width, player.height, DustID.TintableDust, 0, 0, 0, Color.Yellow, (1 + Main.rand.Next(5)) * 0.1f);
            }
        }
        public override void Update(NPC npc, ref int buffIndex)
        {
			...
			if (Main.rand.NextBool(30))
			{
            	Dust.NewDust(npc.position, npc.width, npc.height, DustID.TintableDust, 0, 0, 0, Color.Yellow, (1+Main.rand.Next(5)) * 0.1f);
			}
        }
    }
}
